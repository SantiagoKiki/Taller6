...
public class VentanaMapa extends JFrame implements ActionListener
{
    ...
    public VentanaMapa( VentanaPrincipal ventanaPrincipal, List<Restaurante> restaurantes )
    {
        ...
        JPanel panelChiquito = new JPanel(new GridLayout(1,2));
        ...
        ButtonGroup seleccionar1 = new ButtonGroup();
        seleccionar1.add(radioTodos);
        seleccionar1.add(radioVisitados);
        panelChiquito.add(radioTodos);
        panelChiquito.add(radioVisitados);
        add(panelChiquito, BorderLayout.SOUTH);

...
public class VentanaAgregarRestaurante extends JFrame
{
    ...
    public VentanaAgregarRestaurante( VentanaPrincipal principal )
    {
        ...
        panelConteiner.setLayout(new BorderLayout());
        panelConteiner.add(panelSur, BorderLayout.CENTER);
        panelConteiner.add(panelBotones, BorderLayout.SOUTH);
        this.add(panelConteiner, BorderLayout.SOUTH);
    ...
    public void agregarRestaurante( )
    {
        ...
        // Obtiene las coordenadas del panelMapa
        int[] coordenadas = panelMapa.getCoordenadas();
        int x = coordenadas[0];
        int y = coordenadas[1];

        // Llama a la ventana principal para agregar el restaurante
